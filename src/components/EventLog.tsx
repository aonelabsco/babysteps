                ...
                <div key={event.id}>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-base text-gray-200 font-medium">{eventDescription(event)}</p>
                  ...
                  {editingId === event.id && (
                    <div className="flex items-center gap-2 px-3 pb-2 ml-10">
                      <input
                        ...
                        className="px-3 py-1.5 rounded-lg text-sm bg-dark-800 text-gray-200 border border-dark-600 focus:outline-none focus:ring-1 focus:ring-accent-500"
                      />
                      <button
                        onClick={(e) => { e.stopPropagation(); handleEditTime(event.id, event.timestamp); }}
                        className="px-3 py-1.5 rounded-lg text-sm bg-accent-500 text-white font-medium hover:bg-accent-600"
                      >
                        save
                      </button>
                      <button
                        onClick={(e) => { e.stopPropagation(); setEditingId(null); }}
                        className="px-3 py-1.5 rounded-lg text-sm bg-dark-800 text-gray-400 hover:bg-dark-700"
                      >
                        cancel
                      </button>
                    </div>
